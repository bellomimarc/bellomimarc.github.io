import{d as u,r as i,o as a,c as l,a as e,t as s,b as h,w as c,F as f,e as g,f as w,_ as v}from"./index-U_JI1TtV.js";const y={class:"company"},_={class:"role-name"},k=u({__name:"WorkExperience",props:{workExperience:{}},setup(d){function n(t){return`${t.toLocaleString("default",{month:"long"})} ${t.getFullYear()}`}const m=d;return(t,p)=>{const o=i("el-timeline-item"),D=i("el-timeline");return a(),l("div",null,[e("div",null,[e("span",y,s(m.workExperience.company),1)]),h(D,null,{default:c(()=>[(a(!0),l(f,null,g(t.workExperience.roles,(r,S)=>(a(),w(o,{key:S,timestamp:n(r.startDate)},{default:c(()=>[e("div",null,[e("h4",_,s(r.role),1),e("p",null,s(r.description),1)])]),_:2},1032,["timestamp"]))),128))]),_:1})])}}}),E=v(k,[["__scopeId","data-v-0b19ae12"]]),x=u({__name:"WorkExperiencesView",setup(d){const n=[{company:"Qomodo",roles:[{role:"Software Architect",startDate:new Date("2024-07-01"),description:`Leading the software architecture at Qomodo, designing scalable
...
Engineer.`}]},{company:"Corvina",roles:[{role:"Senior Full Stack Engineer",startDate:new Date("2022-07-01"),endDate:new Date("2024-07-01"),description:`I’m developing a microservice industrial IoT platform that helps customers to create dashboards and deploy new software on their devices.
...
- myMarsh: interface for policyholders of life insurance and medical expense reimbursement policies Technologies used: Bootstrap, jQuery, .NET Framework, LINQ to SQL, TSQL.`}]}];return(m,t)=>{const p=i("el-scrollbar");return a(),w(p,{height:"30rem"},{default:c(()=>[(a(),l(f,null,g(n,o=>e("div",{key:o.company},[h(E,{workExperience:o},null,8,["workExperience"])])),64))]),_:1})}}});export{x as default};
